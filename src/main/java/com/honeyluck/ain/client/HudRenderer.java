...
public class HudRenderer {
    ...
    public static void render() {
        ...
        EnumHealthColour color = EnumHealthColour.getColour(healthPercent);
        IFairy handler = CapabilityFairy.get(player);
        float manaPercent = (handler.getMana() / handler.getMaxMana());
        ...
        int width = (int) (119 * healthPercent);
        int manaWidth = (int) (119 * healthPercent);
        ...
        RenderUtils.drawModalRectWithCustomSizedTexture(36, 14, 32, 24, manaWidth, 3, 256, 256);
        if(manaWidth >= 60) {
            RenderUtils.drawModalRectWithCustomSizedTexture((int) (manaWidth + 36), 14, 151, 24, 1, 2, 256, 256);
        } else {
            RenderUtils.drawModalRectWithCustomSizedTexture((int) (manaWidth + 36), 14, 91, 24, 1, 2, 256, 256);
        }
